...
library GameConfig {
    ...
    function setLevel(IWavGame.Level storage uniqueLevel, IWavGame.LevelParam memory updateParam) internal  {
        uniqueLevel.base.requiredBurn = updateParam.requiredBurn;
        uniqueLevel.base.requiredMint = updateParam.requiredMint;
        uniqueLevel.base.prizeCutOff = updateParam.prizeCutOff;
